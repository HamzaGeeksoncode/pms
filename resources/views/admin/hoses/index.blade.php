                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Hoses</h4>
                            <a href="{{ route("hoses.create") }}" type="submit" class="btn btn-outline-primary add-btn">Add Hose</a>
                        </div>
                        <div class="card-body">
...
@parent
@php
    $url = isset(request()->test_id) ? route('hoses.index') . '?test_id=1' : route('hoses.index');
