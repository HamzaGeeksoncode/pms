                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="{{ route("clients-payments.create") }}" type="submit" class="btn btn-outline-primary add-btn">Add Client Payment</a>
                        </div>
                        <div class="card-body">
...
@parent
@php
    $url = isset(request()->test_id) ? route('clients-payments.index') . '?test_id=1' : route('clients-payments.index');
