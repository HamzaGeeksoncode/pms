                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="{{ route("tanks.create") }}" type="submit" class="btn btn-outline-primary add-btn">Add Tank</a>
                        </div>
                        <div class="card-body">
...
@parent
@php
    $url = isset(request()->test_id) ? route('tanks.index') . '?test_id=1' : route('tanks.index');
