                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="needs-validation" action="{{ route('clients.update',[$client['id']]) }}" method="POST" novalidate  >
                                    @method('PUT')
                                    @csrf  
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="text" value="{{ old('name', $client['name']) }}" name="name" class="form-control" placeholder="{{ trans('cruds.common.enter') }} {{ trans('cruds.clients.name') }}" required>
                                                    @if($errors->has('name'))
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="text" value="{{ old('company_name', $client['company_name']) }}" name="company_name" class="form-control" placeholder="{{ trans('cruds.common.enter') }} {{ trans('cruds.clients.company_name') }}" required>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="text" value="{{ old('contact_number_1', $client['contact_number_1']) }}" name="contact_number_1" class="form-control" placeholder="{{ trans('cruds.common.enter') }} {{ trans('cruds.clients.contact_number_1') }}" required>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="text" value="{{ old('contact_number_2', $client['contact_number_2']) }}" name="contact_number_2" class="form-control" placeholder="{{ trans('cruds.common.enter') }} {{ trans('cruds.clients.contact_number_2') }}" required>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="checkbox" {{ $client['pay_type'] == 'credit' ? 'checked' : '' }} name="pay_type" name="pay_type">  Allow Credit Payment
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <select  class="form-control" id="petrol_limit" name="petrol_limit" required>
                                                        ...
                                                        <option {{ $client['petrol_limit'] ==  'daily' ? 'selected' : '' }} value="daily" >{{ trans('cruds.clients.daily') }}</option>
                                                        <option {{ $client['petrol_limit'] ==  'weekly' ? 'selected' : '' }} value="weekly" >{{ trans('cruds.clients.weekly') }}</option>
                                                        <option {{ $client['petrol_limit'] ==  'monthly' ? 'selected' : '' }} value="monthly" >{{ trans('cruds.clients.monthly') }}</option>
                                                    </select> 
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="number" value="{{ old('petrol_discount', $client['petrol_discount']) }}" name="petrol_discount" class="form-control" placeholder="Petrol Discount" required>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="number" value="{{ old('petrol_quan', $client['petrol_quan']) }}" name="petrol_quan" class="form-control" placeholder="Petrol Discount" required>
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <select  class="form-control" id="diesel_limit" name="diesel_limit" >
                                                        <option selected  value="no_limit">No Limit</option>
                                                        <option {{ $client['diesel_limit'] ==  'daily' ? 'selected' : '' }} value="daily" >{{ trans('cruds.clients.daily') }}</option>
                                                        <option {{ $client['diesel_limit'] ==  'weekly' ? 'selected' : '' }} value="weekly" >{{ trans('cruds.clients.weekly') }}</option>
                                                        <option {{ $client['diesel_limit'] ==  'monthly' ? 'selected' : '' }} value="monthly" >{{ trans('cruds.clients.monthly') }}</option>
                                                    </select> 
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="number" value="{{ old('diesel_discount', $client['diesel_discount']) }}" name="diesel_discount" class="form-control" placeholder="Diesel Discount" required>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-lg-12">
                                                    <input type="number" value="{{ old('diesel_quan', $client['diesel_quan']) }}" name="diesel_quan" class="form-control" placeholder="Diesel Discount" required>
