                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="{{ route("clients.create") }}" type="submit" class="btn btn-outline-primary add-btn">Add Client</a>
                        </div>
                        <div class="card-body">
...
@parent
@php
    $url = isset(request()->test_id) ? route('clients.index') . '?test_id=1' : route('clients.index');
    ...
    $(function () {
        ...
        let dtOverrideGlobals = {
                ...
                columns: [
                    ...
                    {data: 'petrol_limit', name: 'petrol_limit'},
                    {data: 'diesel_limit', name: 'diesel_limit'},
